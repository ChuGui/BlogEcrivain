...
use BlogEcrivain\Domain\Article;
use BlogEcrivain\Domain\User;
use BlogEcrivain\Form\Type\ArticleType;
use BlogEcrivain\Form\Type\CommentForm;
...
class AdminController {
    ...
    public function editCommentAction($id, Request $request, Application $app) {
        ...
        $commentForm = $app['form.factory']->create(CommentForm::class, $comment);
